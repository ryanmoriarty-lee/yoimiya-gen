...
import (
	"github.com/ryanmoriarty-lee/yoimiya-gen/app/console/command/demo"
	"github.com/ryanmoriarty-lee/yoimiya-gen/framework"
	"github.com/ryanmoriarty-lee/yoimiya-gen/framework/cobra"
	"github.com/ryanmoriarty-lee/yoimiya-gen/framework/command"
)
...
func RunCommand(container framework.Container) error {
	...
	var rootCmd = &cobra.Command{
		...
		Short: "yoimiya 命令",
		// 根命令的详细介绍
		Long: "yoimiya 框架提供的命令行工具，使用这个命令行工具能很方便执行框架自带命令，也能很方便编写业务命令",
		// 根命令的执行函数
