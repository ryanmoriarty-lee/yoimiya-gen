...
import (
  ...
  testdata "github.com/ryanmoriarty-lee/yoimiya-gen/framework/gin/testdata/protoexample"
)
...
func TestContextHandlerName(t *testing.T) {
  ...
  assert.Regexp(t, "^(.*/vendor/)?github.com/ryanmoriarty-lee/yoimiya-gen/framework/gin.handlerNameTest$", c.HandlerName())
}
