...
type Trace interface {
	// // SetTraceIDService set TraceID generator, default yoimiyaIDGenerator
	// SetTraceIDService(IDService)
	// // SetTraceIDService set SpanID generator, default yoimiyaIDGenerator
