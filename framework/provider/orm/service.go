...
// YoimiyaGorm 代表yoimiya框架的orm实现
type YoimiyaGorm struct {
...
// NewYoimiyaGorm 代表实例化Gorm
func NewYoimiyaGorm(params ...interface{}) (interface{}, error) {
...
// GetDB 获取DB实例
func (app *YoimiyaGorm) GetDB(option ...contract.DBOption) (*gorm.DB, error) {
