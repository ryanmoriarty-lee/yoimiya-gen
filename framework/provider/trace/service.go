...
type YoimiyaTraceService struct {
...
func NewYoimiyaTraceService(params ...interface{}) (interface{}, error) {
  c := params[0].(framework.Container)
  idService := c.MustMake(contract.IDKey).(contract.IDService)
  return &YoimiyaTraceService{idService: idService}, nil
}

// WithTrace register new trace to context
func (t *YoimiyaTraceService) WithTrace(c context.Context, trace *contract.TraceContext) context.Context {
...
func (t *YoimiyaTraceService) GetTrace(c context.Context) *contract.TraceContext {
  if ginC, ok := c.(*gin.Context); ok {
...
func (t *YoimiyaTraceService) NewTrace() *contract.TraceContext {
...
func (t *YoimiyaTraceService) StartSpan(tc *contract.TraceContext) *contract.TraceContext {
...
// GetTrace By Http
func (t *YoimiyaTraceService) ExtractHTTP(req *http.Request) *contract.TraceContext {
  tc := &contract.TraceContext{}
...
// Set Trace to Http
func (t *YoimiyaTraceService) InjectHTTP(req *http.Request, tc *contract.TraceContext) *http.Request {
...
func (t *YoimiyaTraceService) ToMap(tc *contract.TraceContext) map[string]string {
  m := map[string]string{}
  if tc == nil {
    return m
  }
...
// func (t *YoimiyaTraceService) SetTraceIDService(service contract.IDService) {
// 	t.traceIDGenerator = service
// }

// func (t *YoimiyaTraceService) SetSpanIDService(service contract.IDService) {
