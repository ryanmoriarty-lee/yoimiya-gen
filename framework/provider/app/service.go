...
// YoimiyaApp 代表yoimiya框架的App实现
type YoimiyaApp struct {
...
// AppID 表示这个App的唯一ID
func (app YoimiyaApp) AppID() string {
  return app.appId
}

// Version 实现版本
func (app YoimiyaApp) Version() string {
  return "0.0.3"
}

// BaseFolder 表示基础目录，可以代表开发场景的目录，也可以代表运行时候的目录
func (app YoimiyaApp) BaseFolder() string {
  if app.baseFolder != "" {
...
func (app YoimiyaApp) ConfigFolder() string {
...
// LogFolder 表示日志存放地址
func (app YoimiyaApp) LogFolder() string {
...
func (app YoimiyaApp) HttpFolder() string {
...
func (app YoimiyaApp) ConsoleFolder() string {
...
func (app YoimiyaApp) StorageFolder() string {
...
func (app YoimiyaApp) ProviderFolder() string {
...
func (app YoimiyaApp) MiddlewareFolder() string {
...
func (app YoimiyaApp) CommandFolder() string {
...
func (app YoimiyaApp) RuntimeFolder() string {
...
func (app YoimiyaApp) TestFolder() string {
...
func (app YoimiyaApp) DeployFolder() string {
...
// NewYoimiyaApp 初始化YoimiyaApp
func NewYoimiyaApp(params ...interface{}) (interface{}, error) {
  if len(params) != 2 {
  ...
  return &YoimiyaApp{baseFolder: baseFolder, container: container, appId: appId, configMap: configMap}, nil
}

// LoadAppConfig 加载配置map
func (app *YoimiyaApp) LoadAppConfig(kv map[string]string) {
...
// AppFolder 代表app目录
func (app *YoimiyaApp) AppFolder() string {
