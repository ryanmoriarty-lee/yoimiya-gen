...
import (
	...
	"github.com/ryanmoriarty-lee/yoimiya-gen/framework/provider/cache"
	...
	"github.com/ryanmoriarty-lee/yoimiya-gen/framework/provider/redis"
...
func main() {
	...
	container.Bind(&cache.YoimiyaCacheProvider{})
